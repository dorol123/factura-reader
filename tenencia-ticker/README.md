...
- **Tenencia por ticker**: elegís un ticker y muestra qué clientes lo tienen (nombre, comitente y valor en USD).
- **Tenencia por cliente**: con el mismo Excel, lista los clientes ordenados por AUM y muestra las posiciones de cada uno
  (ticker, días de tenencia, valor en USD y % de su cartera).
